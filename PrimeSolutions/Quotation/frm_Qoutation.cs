...
{
    public partial class frm_Qoutation : Form
    {
        ...
        {
            txt_BillNo.Text = _objSQLHelper.GetMaxID("Q", "0");
        ...
        private void txt_Extra_TextChanged(object sender, EventArgs e)
        {
