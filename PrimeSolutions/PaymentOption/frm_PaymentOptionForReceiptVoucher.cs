...
{
    public partial class frm_PaymentOptionForReceiptVoucher : Form
    {
        ...
        public frm_PaymentOptionForReceiptVoucher(string Amountpaid, string billno, String Accountno, String Date, CustomerType CustomerType, OperationType OperationType, string VoucherTypeId = "", string VoucherId = "")
        {
            InitializeComponent();
                ...
                if (data.Count != 0)
                {
                    ...
                    switch (PaymentType)
                    {
                        ...
                        case "CARD":
                            ...
                            txtbanknamecard.SelectedItem = dtr.Rows[0]["Bank_name"].ToString();
                            txt_cardno.Text = dtr.Rows[0]["Card_chequeno"].ToString();
                        ...
                        case "CHEQUE":
                            ...
                            txt_bankname.SelectedItem = dtr.Rows[0]["Bank_name"].ToString();
                        ...
                        case "PARTIAL":
                            ...
                            {
                                tbc_PaymentDetails.SelectedIndex = 1;
                                txtbanknamecard.SelectedItem = dtr.Rows[1]["Bank_name"].ToString();
                                txt_cardno.Text = dtr.Rows[1]["Card_chequeno"].ToString();
                            ...
                            {
                                tbc_PaymentDetails.SelectedIndex = 2;
                                txt_bankname.SelectedItem = dtr.Rows[1]["Bank_name"].ToString();
        ...
        private void rbtPayCheque_Click(object sender, EventArgs e)
        {

            txt_bankname.Focus();
        }

        private void rbtPayCard_Click(object sender, EventArgs e)
        {

            txtbanknamecard.Focus();
        }
        ...
        private void txtbanknamecard_TextChanged(object sender, EventArgs e)
        {
            errbnkname.Visible = false;
        }

        private void txt_bankname_TextChanged(object sender, EventArgs e)
        {
            errbnkncheque.Visible = false;
        }
        ...
        private void txtbanknamecard_KeyDown_1(object sender, KeyEventArgs e)
        {
            if (e.KeyCode == Keys.Enter)
            {
                txt_cardno.Focus();
        ...
        public bool check1()
        {
            ...
            if (tbc_PaymentDetails.SelectedTab == tb_Cheque)
            {
                ...
                {
                    Status = AssignData(payMod: "CHEQUE", bankName: txt_bankname.Text, cardOrChequeNo: txtchequeno.Text, narration: txtnarrationcheque.Text, cashAmount: (chk_PartialCheque.Checked == true) ? txt_PartialAmountCheque.Text : lblchequeamt.Text, otherTransactionAmount: (chk_PartialCheque.Checked == true) ? lbl_BalanceAmountCheque.Text : null, transactionLedgerID: CmbDebitToCheque.SelectedValue.ToString());
        ...
        private bool AssignData(string narration = "", string bankName = "", string cardOrChequeNo = "", string payMod = "", string cashAmount = "0", string otherTransactionAmount = "0", string transactionLedgerID = null)
        {
            ...
            if (payMod != "CASH")
            {
                if (_objvalidation.IsNotEmpty(bankName))
                {
