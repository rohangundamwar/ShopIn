...

{
    public partial class frm_SaleEstimate : Form
    {
        ...
        private void bttn_Sale_Click(object sender, EventArgs e)
        {
            ...
            try
            {
                _Sale.AddBillDetails(txt_BillNo.Text, txt_AccNo.Text, dtp_Date.Value.ToString("dd/MM/yyyy"), txt_TotalAmt.Text, lbl_CGSTValue.Text, lbl_SGSTValue.Text, lbl_IGSTValue.Text, txt_NetAmt.Text, cmb_State.Text, txt_BillAmt.Text, txt_Discount.Text, "Estimate");
